...
const questionsPool = [
  {
    ...
    correctAnswer: "B",
    explanation:
      "Phishing is a type of cyberattack where attackers send fraudulent emails pretending to be from a legitimate source to trick users into providing sensitive information.",
    securityTip:
      "Always verify the sender's email address and avoid clicking on suspicious links in emails.",
  },
  {
    id: 2,
    ...
    correctAnswer: "B",
    explanation:
      "A strong password includes a mix of letters, numbers, and special symbols to make it hard to crack.",
    securityTip:
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "C",
        text: "An extra layer of security using a second verification method",
      },
    ...
    securityTip:
      "Enable 2FA on all your accounts to protect against unauthorized access.",
  },
  {
    id: 4,
    ...
    options: [
      ...
      {
        id: "B",
        text: "Malicious software that locks or encrypts your data until a ransom is paid",
      },
    ...
    correctAnswer: "B",
    explanation:
      "Ransomware locks your data and demands payment to regain access.",
    securityTip:
      "Back up your important data to avoid being a victim of ransomware.",
  },
  {
    id: 5,
    question:
      "Why should you avoid using public Wi-Fi for sensitive activities?",
    options: [
    ...
    correctAnswer: "B",
    explanation:
      "Public Wi-Fi networks are often unencrypted, allowing attackers to intercept your data, such as login credentials or personal information.",
    securityTip:
      "Use a VPN (Virtual Private Network) when connecting to public Wi-Fi to encrypt your connection.",
  },
  {
    id: 6,
    ...
    options: [
      ...
      {
        id: "B",
        text: "Trying all possible passwords to gain unauthorized access",
      },
    ...
    securityTip:
      "Use strong and unique passwords to resist brute-force attacks.",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    correctAnswer: "A",
    explanation:
      "A firewall filters incoming and outgoing network traffic to protect against threats.",
  ...
  },
  {
    ...
    options: [
      {
        id: "A",
        text: "Manipulating people into giving sensitive information",
      },
  ...
  },
  {
    ...
    correctAnswer: "A",
    explanation:
      "Changing your password quickly helps regain control of your account.",
    securityTip:
  ...
  },
  {
    ...
    correctAnswer: "A",
    explanation:
      "Antivirus software is designed to detect and remove harmful programs like viruses and malware from your device.",
    securityTip:
      "Always keep your antivirus software up-to-date for maximum protection.",
  },
  {
    id: 12,
    ...
    options: [
      {
        id: "A",
        text: "Manipulating people into revealing sensitive information",
      },
    ...
    correctAnswer: "A",
    explanation:
      "Social engineering exploits human psychology to gain access to confidential information or systems.",
    securityTip:
      "Be cautious of unexpected requests for sensitive data, even if they appear to come from a trusted source.",
  },
  {
    id: 13,
    ...
    correctAnswer: "A",
    explanation:
      "A secure website includes HTTPS and a lock icon, indicating that your connection is encrypted.",
    securityTip:
      "Check for HTTPS in the URL before entering personal information on a website.",
  },
  {
    id: 14,
    ...
    correctAnswer: "A",
    explanation:
      "Software updates often include patches that fix security vulnerabilities and improve functionality.",
    securityTip:
      "Enable automatic updates to ensure your devices are secure at all times.",
  },
  {
    id: 15,
    question:
      "What should you do if you receive an unexpected file attachment?",
    options: [
    ...
    correctAnswer: "B",
    explanation:
      "Unexpected file attachments might contain malware. It is important to scan them before opening.",
    securityTip:
      "Ensure your antivirus software is active and updated to scan attachments effectively.",
  },
  {
    id: 16,
    question: "What is ransomware?",
    options: [
      ...
      {
        id: "B",
        text: "Malicious software that locks or encrypts your data until payment is made",
      },
    ...
    correctAnswer: "B",
    explanation:
      "Ransomware blocks access to your system or data and demands a ransom for its release.",
    securityTip:
      "Back up your data regularly and avoid clicking on suspicious links to prevent ransomware attacks.",
  },
  {
    id: 17,
    question:
    ...
    options: [
      ...
      {
        id: "B",
        text: "If one account is breached, all linked accounts are at risk",
      },
    ...
    correctAnswer: "B",
    explanation:
      "Using the same password for multiple accounts increases vulnerability if one account is compromised.",
    securityTip:
      "Use unique and strong passwords for every account and store them securely in a password manager.",
  },
  {
    id: 18,
    ...
    options: [
      ...
      {
        id: "B",
        text: "A secure way to browse the web by encrypting your connection",
      },
    ...
    correctAnswer: "B",
    explanation:
      "A VPN encrypts your internet connection, making your online activities private and secure.",
    securityTip:
      "Use a VPN when accessing public Wi-Fi or sensitive websites to protect your data.",
  },
  {
    id: 19,
    ...
    options: [
      {
        id: "A",
        text: "A software vulnerability actively exploited before it is patched",
      },
    ...
    correctAnswer: "A",
    explanation:
      "Zero-day vulnerabilities refer to newly discovered flaws exploited before fixes are released.",
    securityTip:
      "Always keep your system updated to minimize the risk of zero-day attacks.",
  },
  {
    id: 20,
    ...
    options: [
      ...
      {
        id: "B",
        text: "Malicious software designed to disrupt or harm systems",
      },
    ...
    correctAnswer: "B",
    explanation:
      "Malware refers to malicious software like viruses, worms, and ransomware.",
    securityTip:
      "Avoid downloading files or software from untrusted sources to prevent malware infection.",
  },
  {
    id: 21,
    ...
    correctAnswer: "B",
    explanation:
      "Oversharing personal information online can lead to identity theft and fraud.",
    securityTip:
      "Limit what you share on social media and adjust privacy settings to protect your information.",
  },
  {
    id: 22,
    ...
    options: [
      {
        id: "A",
        text: "A file that verifies the authenticity of websites or software",
      },
    ...
    correctAnswer: "A",
    explanation:
      "Digital certificates are used to verify the authenticity of websites and applications.",
    securityTip:
      "Ensure that websites with digital certificates have HTTPS enabled for secure communication.",
  },
  {
    id: 23,
    ...
    options: [
      ...
      {
        id: "C",
        text: "Emails from unknown senders asking for sensitive information",
      },
      { id: "D", text: "All of the above" },
    ],
    correctAnswer: "D",
    explanation:
      "Phishing emails often include suspicious links, errors, urgency, and requests for sensitive information.",
    securityTip:
      "Always verify emails before clicking on links or providing personal data.",
  },
  {
    id: 24,
    ...
    options: [
      ...
      {
        id: "B",
        text: "A method to scramble data to prevent unauthorized access",
      },
    ...
    correctAnswer: "B",
    explanation:
      "Encryption secures data by converting it into unreadable formats for unauthorized users.",
    securityTip:
      "Use encryption tools to protect sensitive files and communication.",
  },
  {
    id: 25,
    ...
    options: [
      {
        id: "A",
        text: "Encryption secures data for transmission, while hashing verifies data integrity",
      },
    ...
    correctAnswer: "A",
    explanation:
      "Encryption is used to secure data during transmission, while hashing creates a unique representation of data to verify its integrity.",
    securityTip:
      "Understand when to use encryption versus hashing to secure your sensitive data appropriately.",
  },
];
